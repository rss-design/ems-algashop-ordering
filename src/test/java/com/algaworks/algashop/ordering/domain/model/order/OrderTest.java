...
class OrderTest {
    ...
    void shouldRecalculateTotals() {
        ...
        Product productRamMemory = ProductTestDataBuilder.aProductAltRamMemory().build();

        order.addItem(productMousePad, new Quantity(2));
        order.addItem(productRamMemory, new Quantity(1));
    ...
    @Test
    void givenPlacedtOrder_whenMarkAsPaid_shouldChangeToPaid() {
    ...
    @Test
    void givenPlacedtOrder_whenTryToPlace_shouldGenerationException() {
        Order order = OrderTestDataBuilder.anOrder().status(OrderStatus.PLACED).build();
    ...
    @Test
    void givenDrafttOrder_whenChangePaymentMethod_shouldAllowChange() {
        Order order = Order.draft(new CustomerId());
    ...
    @Test
    void givenDrafttOrder_whenChangeBilling_shouldAllowChange() {
    ...
    @Test
    void givenDrafttOrder_whenChangeShipping_shouldAllowChange() {
    ...
    @Test
    void givenDrafttOrderAndDeliveryDateInThePast_whenChangeShipping_shouldNotAllowChange() {
