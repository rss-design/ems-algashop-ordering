...
import com.algaworks.algashop.ordering.core.domain.model.AbstractRepositoryIT;
...
class CustomersIT extends AbstractRepositoryIT {
    ...
    void shouldReturnIfEmailInUse() {
        ...
        Assertions.assertThat(customers.isEmailUnique(new Email("rafael@gmail.com"), new CustomerId())).isTrue();
    }
