...
public class ShoppingCartOutputTestDataBuilder {
  ...
  private static ShoppingCartItemOutput.ShoppingCartItemOutputBuilder existingItem() {
  ...
  private static ShoppingCartItemOutput.ShoppingCartItemOutputBuilder existingItemAlt() {
    return ShoppingCartItemOutput.builder()
      .id(UUID.randomUUID())
      .productId(UUID.randomUUID())
