...
public class Order extends AbstractEventSourceEntity implements AggregateRoot<OrderId> {
    ...
    public void place() {
        ...
        publishDomainEvent(
            new OrderPlacedEvent(this.id(), this.customerId(), this.placedAt())
        );
    }
    ...
    public void markAsPaid() {
        ...
        publishDomainEvent(
            new OrderPaidEvent(this.id(), this.customerId(), this.paidAt())
        );
    }
    ...
    public void markAsReady() {
        ...
        publishDomainEvent(
            new OrderReadyEvent(this.id(), this.customerId(), this.readyAt())
        );
    }
    ...
    public void cancel() {
        ...
        publishDomainEvent(
            new OrderCanceledEvent(this.id(), this.customerId(), this.canceledAt())
        );
    }
