...
public class ErrorMessages {
    public static final String VALIDATION_ERROR_INVALID_EMAIL
        = "Invalid email";
    public static final String VALIDATION_ERROR_BIRTHDATE_MUST_IN_PAST
        = "BirthDate must be a past date";
    public static final String VALIDATION_ERROR_FULLNAME_IS_NULL
