...
public class ModelMapperConfig {
    ...
    private void configuration(ModelMapper modelMapper) {
        modelMapper.getConfiguration()
            .setSourceNamingConvention(NamingConventions.NONE) // para não utilizar o padrao JABA_BEANs (getMethod... setMethod)
            .setDestinationNamingConvention(NamingConventions.NONE)
            .setMatchingStrategy(MatchingStrategies.STRICT); // Como o modelmapper entende o nome das propriedades. (Nomes completamente iguais. Fica mais seguro.)
